...
class WebAppUsageChartResponse(BaseModel):
    ...
    period_total_text: str | None = None
    avg_daily_text: str | None = None
    peak_label: str | None = None
    peak_value_text: str | None = None
    page_total_text: str | None = None
    day_label: str | None = None
    day_jalali: str | None = None
    day_total_text: str | None = None
